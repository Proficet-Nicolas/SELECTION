...
$id_grilles = isset($_POST['id_grilles']) ? $_POST['id_grilles'] : '';
  ...
  
{
 ...
 $sql = "INSERT INTO `grilles`(`numero_candidat`, `nom`, `prenom`, `serie`, `travail_serieux`, `absence`, `comportement`, `etude_sup`, `avis_pp`, `avis_proviseur`, `lettre_motivation`, `remarques`, `note_jury`) VALUES (:numero_candidat,:nom,:prenom,:serie,:travail_serieux,:absence,:comportement,:etude_sup,:avis_pp,:avis_proviseur,:lettre_motivation,:remarques,:note_jury)";
 $res = $db->prepare($sql);
